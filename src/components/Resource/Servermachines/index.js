import { Table, Input, Popconfirm, Alert, Badge, Divider, Icon,Switch, Select, Tooltip} from 'antd';
    ...
    columns = [{
        ...
        render: (text, record) => {
          return (
            <Select 
              ...
              defaultValue={text[0]} 
              style={{ width: 'auto' }} 
              onChange={(value)=>{this.handSelectChange(value)}}
        ...
        render: (text, record) => {
          ...
          return (
            <Select 
              ...
              disabled={record.selectStatus}
            >
              <Option key='stop1' value="1">在保</Option>
              <Option key='stop2' value="0">过保</Option>
            </Select>)
        },
    }, {
        title: '机器名称',
            ...
            <div>
              ...
              <span>
                <Tooltip placement="topLeft" title="点击查看密码" arrowPointAtCenter>
                  <Icon type="unlock" style={{ fontSize: 16, color: '#08c' }}  onClick={()=>{this.passwordClick(record.ID)}}/>
                </Tooltip>
              </span>
            </div>
          )
        ...
        render: (text, record) => {
            ...
            <div className="editable-row-operations">
                ...
                {
                  <span style={{marginLeft: 10}}>
                    <a onClick={()=>{this.detailClick(record.ID)}}>详情</a>
                  </span>
                }
            </div>
            );
    ...
    renderSelect(text, record, column) {
      ...
      return (
        <Select 
          ...
          disabled={record.selectStatus}
        >
          <Option key={text+'jack'} value="jack">Jack</Option>
        </Select>
      );
    }
