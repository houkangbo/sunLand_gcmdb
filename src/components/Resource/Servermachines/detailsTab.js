...
class detailsTab extends PureComponent {
  ...
  tabArrRenderEl(key){
    ...
    const nameStr= "主机名 网卡1 网卡2 网卡3 网卡4 网卡bond 地址,第一块网卡pxe 远控卡ip 硬件厂家 硬件厂商 硬件类型 Cpu型号 x86_64andi386 cpu核数 系统版本 硬盘 内存 资产编号 交换机端口 快速服务编号 SN编号 bios日期 bios版本 备注说明 系统环境 agent版本"
